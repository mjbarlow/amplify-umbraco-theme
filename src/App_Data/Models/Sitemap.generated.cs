...
namespace Umbraco.Web.PublishedModels
{
	...
	public partial class Sitemap : PublishedContentModel, IHeaderTitleComposition, INavigationBase, IPageSettings, IXMlsiteMapSettings
	{
		// helpers
...
#pragma warning restore 0109
		...
		///<summary>
		/// Allowed Listed Document Types: Comma separated list of the document types that should be included in the site map.
		///</summary>
		[global::System.CodeDom.Compiler.GeneratedCodeAttribute("Umbraco.ModelsBuilder", "8.1.6")]
		[ImplementPropertyType("allowedListedDocumentTypes")]
		public string AllowedListedDocumentTypes => this.Value<string>("allowedListedDocumentTypes");
